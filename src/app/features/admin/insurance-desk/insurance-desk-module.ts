/**
 * @deprecated Not registered in `app-routing` — admin insurance is handled by
 * `InsuranceAdminComponent` inside `BackofficeComponent`. Kept for reference / possible merge of UX ideas.
 */
