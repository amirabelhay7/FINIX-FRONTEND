...
loadSimulations(): void {
  ...
  delinquencies = [
    {
      initials: "FB", name: "Farouk Ben Ali", city: "Tunis", phone: "+216 20 111 222",
      dossier: "#CR-2024-018", product: "Consommation · 24 mois", amount: "310 TND",
      delay: "J+3", risk: "Modéré", sms: "1 SMS · 0 appel"
    },
    {
      initials: "HG", name: "Hanen Gharbi", city: "Sfax", phone: "+216 24 333 444",
      dossier: "#CR-2023-092", product: "Automobile · 60 mois", amount: "890 TND",
      delay: "J+14", risk: "Élevé", sms: "3 SMS · 2 appels"
    }
  ];

  clients = [
    {
      initials: "BM", name: "Bilel Mrabet", email: "bilel.mrabet@email.com",
      phone: "+216 20 123 456", cin: "08 123 456", city: "Tunis",
      score: 742, scoreColor: "var(--success)", credits: "3 active",
      encours: "24 500 TND", kyc: "Complete", status: "Active", statusClass: "b-actif"
    },
    {
      initials: "LB", name: "Leila Bourguiba", email: "l.bourguiba@email.com",
      phone: "+216 22 654 321", cin: "12 456 789", city: "Sousse",
      score: 610, scoreColor: "var(--warning)", credits: "1 active",
      encours: "32 500 TND", kyc: "Partial", status: "Active", statusClass: "b-actif"
    }
  ];

  pipelineColumns: PipelineColumn[] = [
    {
      title: "New", class: "ph-new", count: 8,
      cards: [
    ...
    {
      title: "Analysis", class: "ph-analysis", count: 12,
      cards: [
  ...
  analysisFiles = [
    {
      ref: "#CR-2025-043", initials: "BM", name: "Bilel Mrabet",
      clientInfo: "Loyal client · 5 years", type: "Real estate", amount: "85 000 TND",
      duration: "180 months", score: 742, debtRatio: 28, seniority: "5 years", recommendation: "Favorable"
    },
    {
      ref: "#CR-2025-051", initials: "LB", name: "Leila Bourguiba",
      clientInfo: "Client · 2 years", type: "Car loan", amount: "32 500 TND",
      duration: "60 months", score: 610, debtRatio: 41, seniority: "2 years", recommendation: "To analyze"
    }
  ];
